<section class="py-0 bg-1000">
    <div class="container">
      <div class="row py-7">
        <div class="col-12 col-sm-12 col-lg-6 mb-4 order-0 order-sm-0"><a class="text-decoration-none" href="#"><img src="{{url('assets/img/gallery/logobpsbogor_light.png')}}" height="51" alt="" /></a>
        ...
        <div class="col-3 col-sm-4 col-lg-2 mb-3 order-2 order-sm-1">
          <h5 class="lh-lg fw-bold text-light font-sans-serif">Layanan Lainnya</h5>
