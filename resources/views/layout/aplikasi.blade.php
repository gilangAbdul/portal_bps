...
<section id="aplikasi">
<div class="container">
    <h1 class="text-center display-5 fw-semi-bold" data-zanim-xs='{"delay":0.3}' data-zanim-trigger="scroll">Aplikasi Sistem</h1>
    <p class="text-center fs-0 fs-md-1" data-zanim-xs='{"delay":0.5}' data-zanim-trigger="scroll"> Temukan berbagai aplikasi inovatif dari BPS Kabupaten Bogor <br class="d-none d-lg-block" /> dirancang untuk memudahkan akses data, analisis, dan pelaporan statistik.</p>
    <div class="row mb-4 mt-6">
    <div class="bg-image hover-zoom">
        <img src="https://mdbcdn.b-cdn.net/img/new/standard/city/053.webp" class="w-10" />
    </div>
    {{-- <div class="col-md-6 col-lg-3 text-center bg-image hover-zoom"><img src="assets/img/icons/4.png" alt="Dashboard" style="width:95px;cursor: pointer;" />
